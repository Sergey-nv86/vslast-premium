...
enum AdminOrderFilter { all, unconfirmed, confirmed, completed }
...
class _AdminOrdersScreenState extends State<AdminOrdersScreen> {
  ...
  Future<void> _scanCustomerQr() async {
    ...
    if (!mounted || cardNumber == null || cardNumber.trim().isEmpty) {
      return;
    }

    try {
      final activeOrders = await AdminOrdersService.instance
          .fetchActiveOrdersByCardNumber(cardNumber);
      ...
      ScaffoldMessenger.of(context)
        ..hideCurrentSnackBar()
        ..showSnackBar(
          SnackBar(content: Text('Не удалось найти заказы клиента: $e')),
        );
    }
  }
