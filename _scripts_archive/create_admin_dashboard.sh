...
cat > lib/features/admin/screens/admin_dashboard_screen.dart <<'DART'
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const _Title('Заказы', 'Все заказы'),
          const SizedBox(height: 10),
          _Card(child: Row(
...
echo "Готово: $TARGET_FILE"
echo
echo "Проверка:"
echo "flutter analyze lib/features/admin/screens/admin_dashboard_screen.dart"
