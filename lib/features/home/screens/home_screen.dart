...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void didUpdateWidget(covariant HomeScreen oldWidget) {
    ...
    if (oldWidget.products != widget.products) {
      ...
      debugPrint('===== HOME PRODUCTS UPDATED =====');
      debugPrint('HOME PRODUCTS COUNT: ${_products.length}');
      debugPrint(
        'HOME IN STOCK COUNT: '
  ...
  void _scrollToTop() {
    ...
    if (_activeCategory != null && mounted) {
  ...
  void _scrollToCategory(ProductCategory category) {
    if (!_scrollController.hasClients || !_categoriesShown.contains(category)) {
      return;
    }
    final viewportWidth =
        _viewportKey.currentContext?.size?.width ??
